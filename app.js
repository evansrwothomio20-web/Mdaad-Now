    ...
    return html`
      <div className="px-4 pb-6 space-y-6">
        ...
        <div className="fade-up pt-4">
          <h1 className="text-3xl font-bold text-navy leading-tight">Welcome</h1>
          <p className="text-sm font-kufi text-slate-400 mt-1 opacity-80 font-medium">مرحباً بك</p>
        </div>
